...
int main()
{
    ...
    while (true)
    {
        ...
        char data;
        printf("\tPROGRAM UAS PSDA BINARY SEACRH TREE\n");
        printf("\tNAMA	: ROMIE ASWARI\n");
        printf("\tNIM	: 1910512009\n");
        printf("\tEMAIL	: romieaswari135@gmail.com\n");
        printf("\t====================================\n");
        printf("\nPILIHAN PADA MENU");
        printf("\n----------\n");
        printf("1) Menambahkan Data Di Program BST\n");
        printf("2) Melihat Hasil Pre-Order\n");
        printf("3) Melihat Hasil In-Order\n");
        printf("4) Melihat Hasil Post-Order\n");
        printf("5) Delete Data Tertentu Pada BST\n");
        printf("6) Mengosongkan Semua Data\n");
        printf("7) Mencari Data Pada BST\n");
        printf("8) Menghitung Jumlah Node Pada Tree\n");
        printf("9) Melihat Hasil Kedalaman Tree\n");
		printf("R) Data Bilangan Terbesar dan Terkecil Pada BST\n");
        printf("x) Keluar\n");
        ...
        switch(pil)
        {
            ...
            case '1':
             ...
             //jika pil bernilai '6'
              ...
              //jika pil bernilai 'R'
               case 'R' :
              		  cout<<"\nData Bilangan Terbesar adalah : "<< findMax() <<endl;
              		  cout<<"\nData Bilangan Terkecil adalah : "<< findMin() <<endl;
